...
import 'package:hive_io/src/crypto/aes_engine.dart';
...
class AesCbcPkcs7 {
  ...
  late final List<Uint32List> _encryptionKey = AesEngine.generateWorkingKey(
    _keyBytes,
    true,
  );
  late final List<Uint32List> _decryptionKey = AesEngine.generateWorkingKey(
    _keyBytes,
    false,
  );
